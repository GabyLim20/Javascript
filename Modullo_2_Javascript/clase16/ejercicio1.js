...
// 1) 
// Añadir un nuevo horario al principio de la lista: Usamos unshift para agregar
// el horario 10 al principio.
horariosAtrasados.unshift(10);
console.log("punto 1", horariosAtrasados);
// 2) Eliminar el último horario de la lista: Usamos pop para eliminar el último
// horario y lo guardamos en ultimoHorario.
let ultimoHorario = horariosAtrasados.pop();
console.log(ultimoHorario);
console.log("punto 2", horariosAtrasados);
// 3) Verificar si el horario 14 está en la lista y agregarlo al final 
// si no está presente: Usamos includes para verificar si 14 está en la lista
...
// 4) Encontrar la posición del horario 18 y eliminarlo si está presente: 
// Usamos indexOf para encontrar la posición de 18 y splice para eliminarlo si está presente.
...
// 5) Añadir el horario eliminado en el paso 2 al final de la nueva lista de 
// horarios atrasados: Usamos push para agregar el ultimoHorario (adelantado una hora) 
// al final de horariosAtrasados.
...
// 7) Eliminar el primer elemento de la lista de horarios atrasados: 
// Usamos shift para eliminar el primer elemento.
horariosAtrasados.shift();
console.log("punto 7", horariosAtrasados);
// 8) Verificar si el horario 9 está en la lista y agregarlo al principio 
// si no está presente: Usamos includes para verificar si 9 está en la lista y unshift
//  para agregarlo si no está.
