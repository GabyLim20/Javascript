...
// 3. Funcion para anadir nuevo estudiante
...
// 6.Funcion para obtener el promedio de calificaciones de estudiantes
...
if(promedio !== null) {
    console.log(`Pormedio de calificaciones: ${promedio}`);
